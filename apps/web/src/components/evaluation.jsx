...
const ROWS = [
  ...
  [3, 'Frontend engineering', '', 4, 'React 19 + Vite 8; app.jsx decomposed 2,613 → 668 lines into domain component modules; ESLint flat config (0 errors); code→friendly-message mapping', 'JavaScript, not TypeScript; component/render tests thin'],
