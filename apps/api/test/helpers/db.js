...
const FILES = [
  ...
  'migration_026_immutable_revisions.sql', 'migration_027_signature_idempotent.sql', 'migration_028_confidential_share.sql', 'docker-grants.sql',
];
...
const DATA_TABLES = [
  ...
  'share_requests', 'policy_groups', 'signatures', 'policy_revisions', 'policies', 'employee_groups', 'group_mappings', 'groups',
